...
public class SimpleConnectionPoolDataSource implements DataSource {
    ...
    public SimpleConnectionPoolDataSource() throws IOException {
        this("src/main/resources/jdbc.properties");
    }
    ...
    public SimpleConnectionPoolDataSource(String configFile) throws IOException {
        ...
        url = properties.getProperty("cc.openhome.url");
        username = properties.getProperty("cc.openhome.username");
        password = properties.getProperty("cc.openhome.password");

        max = Integer.parseInt(properties.getProperty("cc.openhome.poolmax"));
    ...
    private class ConnectionWrapper implements Connection {
        ...
        public void close() throws SQLException {
            System.out.println("connection size: " + conns.size());
            if(conns.size() == max) {
